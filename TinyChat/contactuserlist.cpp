...
ContactUserList::ContactUserList(QWidget *parent): add_friend_item_(nullptr)
  ,load_pending_(false)
{
    Q_UNUSED(parent);
...
void ContactUserList::addContactUserList() {
    ...
    add_friend_item_ = new ConUserItem();
    add_friend_item_->setObjectName("new_friend_item");
    add_friend_item_->setInfo(0,tr("新的朋友"),":/res/add_friend.png");
    add_friend_item_->setItemType(ListItemType::ApplyFriendItem);
